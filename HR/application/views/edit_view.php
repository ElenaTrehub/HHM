                  ...
                  <div class="col-md-3" style="top: 0">
                        <div id="personal-main" class="create-personal">
                              ...
                              <div>
                                    ...
                                    <input type="hidden" name="id" value=<?php echo ($this->employeeId); ?>>
                                    <input type="text" autocomplete="off" name="Name" class="bio-value"
                                          value=<?php if($this->employeeId!= ''){echo $this->employee->Name;}else{echo '';} ?>>
                              </div>

                              <div>
                                    <div class="bio-description">Vorname</div>
                                    <input type="text" autocomplete="off" name="LastName" class="bio-value"
                                          value=<?php if($this->employeeId!= ''){echo $this->employee->LastName;}else{echo '';} ?>>
                              </div>

                              <div>
                                    <div class="bio-description">Arbeitsstatus</div>                                   
                                    <input list="WorkStatus" autocomplete="off" type="text" name="Status" class="bio-value" value="<?php if($this->employeeId!= ''){echo $this->employee->Status;}else{echo '';} ?>">
                              ...
                              <div class="col-md-6">
                                    <div class="create-personal">
                                          ...
                                          <div class="create-personal-content">
                                                ...
                                                <input type="date" autocomplete="off" name="BirthDate" class="bio-value"
                                          ...
                                          <div>                                                
                                                ...
                                                <input type="text" autocomplete="off" name="Address" class="bio-value"
                                                      value=<?php if($this->employeeId!= ''){echo $this->employee->Address;}else{echo '';} ?>>
                                          </div>
                                          <div>
                                                <div class="bio-description">PLZ</div>
                                                <input type="text" autocomplete="off" name="PLZ" class="bio-value"
                                          ...
                                          <div>
                                                ...
                                                <input type="tel" autocomplete="off" name="Phone" class="bio-value"
                                    ...
                                    <div class="create-personal-short">
                                          ...
                                          <div>
                                                ...
                                                <input type="mail" autocomplete="off" name="G17_email" class="bio-value"
                                                      value=<?php if($this->employeeId!= ''){echo $this->employee->G17_email;}else{echo '';} ?>>
                                          </div>
                                          <div>
                                                <div class="bio-description">G17 Kürzel</div>
                                                <input type="text" autocomplete="off" name="G17_initials" class="bio-value"
                              ...
                              <div class="create-personal-short">
                                    ...
                                    <div class="create-personal-short">
                                          ...
                                          <div>
                                                ...
                                                <input type="text" autocomplete="off" name="HHM_email" class="bio-value"
                                                      value=<?php if($this->employeeId!= ''){echo $this->employee->HHM_email;}else{echo '';} ?>>
                                          </div>
                                          <div>
                                                <div class="bio-description">HHM Kürzel</div>
                                                <input type="text" autocomplete="off" name="HHM_initials" class="bio-value"
...
<div id="visitTemplate" class="create-personal-short collapse">
      ...
      <div>
            <div class="bio-description">Reisebeginn</div>
            <input type="date" autocomplete="off" name="visit[VisitStart_1]" class="bio-value">
      </div>
      <div>
            <div class="bio-description">Reiseende</div>
            <input type="date" autocomplete="off" name="visit[VisitEnd_1]" class="bio-value">
      </div>
      <div>
            <div class="bio-description">Standort</div>
            <input type="text" autocomplete="off" name="visit[VisitLocation_1]" class="bio-value">
      </div>
      <div>
            <div class="bio-description">Unterkunft</div>
            <input type="text" autocomplete="off" name="visit[VisitAccommodation_1]" class="bio-value">
      </div>
      <div>
            <div class="bio-description">Ziel</div>
            <input type="text" autocomplete="off" name="visit[VisitGoal_1]" class="bio-value">
      </div>
      <div>
            <div class="bio-description">Gruppe</div>
...
<div id="childTemplate" class="create-personal-child collapse">
      ...
      <div>
            <div class="bio-description">Kinder Name</div>
            <input type="text" name="child[ChildName_1]" autocomplete="off" class="bio-value">
      </div>
      <div>
            <div class="bio-description">Kinder Vorame</div>
            <input type="text" name="child[ChildLastName_1]" autocomplete="off" class="bio-value">
      </div>
      <div>
            <div class="bio-description">Geburtsdatum</div>
            <input type="date" name="child[ChildBirthday_1]" autocomplete="off" class="bio-value">
      </div>
</div>
