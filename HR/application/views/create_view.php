                              ...
                              <div class="col-md-4">
                                    ...
                                    <div class="create-personal">
                                          ...
                                          <div class="personal-image">
                                                ...
                                                <img src=<?php echo $this->user_passport; ?>
                                                onerror="this.onerror=null;">
                                                <?php if($this->user_passport_name!= '') {?>
                                                      <a href="<?php echo $this->user_passport_name; ?>" target="_blank">Dokument öffnen</a>
                                                <?php } ?>
                                                ...
                                                <input type="hidden" name="Pass_Photo" value=<?php echo $this->user_passport_name; ?>>
                                                <div class="input-buttons">
