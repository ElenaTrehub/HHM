<table class="table table-striped table-bordered table-light vacation-table" >
      ...
      <tbody >
            ...
            <tr class="vacation">
                  ...
                  <td class="vacationMonthTotal vacation"><?php print htmlentities($employee->Total);?></td>
                  <td class="vacationMonthTotal vacation"><?php print htmlentities($employee->Used);?></td>
                  <td class="vacationMonthTotal vacation"><?php print htmlentities($employee->NotUsed);?></td>
                  <?php foreach ($employee->Duration as $duration): ?>
                  <td class="vacationMonth vacation" ><?php print htmlentities($duration);?></td>
                  <?php endforeach?>
            </tr>
            <?php endforeach;?>
      </tbody>
