...
function EmployeeOccupation(btn){

    var employeeId = btn.dataset.id;
    console.log(employeeId);
    if(employeeId){
        
        $('html').html("<form action='/HR/employeetasks' name='vote' method='post' style='display:none;'><input type='text' name='idEmployee' value=" + employeeId + " /></form>");
